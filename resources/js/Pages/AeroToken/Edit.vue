        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <FormSection @submitted="store">
                ...
                <template #description>
                    <p>This data is used by api router, insure that iata code is unique, there is one iata code for each
                        token.</p>
                ...
                <template #form>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <TextInput id="iata" ref="iata" v-model="form.iata" type="text" class="mt-1 block w-full" />
                        <InputError :message="form.errors.iata" class="mt-2" />
                    </div>

                    <div class="col-span-6 sm:col-span-4">
                        <InputLabel for="type" value="Type" />
                        <TextInput id="type" ref="type" v-model="form.type" type="text" class="mt-1 block w-full" />
                ...
                <template #form>
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                            <button v-for="(mode, i) in modes" :key="mode.id" type="button"
                                ...
                                <div :class="{ 'opacity-50': form.token.mode && form.token.mode != mode.id }">
                                    ...
                                    <div class="flex items-center">
                                        <div class="text-sm text-gray-600"
                                            :class="{ 'font-semibold': form.token.mode == mode.id }">
                                            {{ mode.name }}
                                        </div>

                                        <svg v-if="form.token.mode == mode.id" class="ms-2 h-5 w-5 text-green-400"
                    ...
                    <template v-if="form.token.mode == 'api'">
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <TextInput id="url" ref="url" v-model="form.token.url" type="url"
                        ...
                        <div class="col-span-6 sm:col-span-4" v-if="form.type == 'videcom'">
                            ...
                            <TextInput id="api_token" ref="api_token" v-model="form.token.api_token" type="text"
                                class="mt-1 block w-full" />
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <TextInput id="currency_code" ref="currency_code" v-model="form.pricing.currency_code"
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <select v-model="form.pricing.profit_from" class="mt-1 block w-3/4">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <TextInput id="profit_percentage" ref="profit_percentage"
                                v-model="form.pricing.profit_percentage_international" type="number" setp="any"
                                class="mt-1 block w-full" />
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <TextInput id="profit_percentage" ref="profit_percentage"
                                v-model="form.pricing.profit_percentage_domestic" type="number" setp="any"
                                class="mt-1 block w-full" />
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <TextInput id="added_tax" ref="added_tax" v-model="form.pricing.added_tax" type="number"
                                class="mt-1 block w-full" />
                    ...
                    <template v-if="form.token.mode == 'user_auth'">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <TextInput id="auth_user" ref="auth_user" v-model="form.token.auth_user" type="text"
                                class="mt-1 block w-full" />
                            <InputError :message="form.errors?.token?.auth_user" class="mt-2" />
                        </div>
                        <div class="col-span-6 sm:col-span-4">
                            <InputLabel for="user_name" value="Auth Pass" />
                            <TextInput id="auth_pass" ref="auth_pass" v-model="form.token.auth_pass" type="password"
                                class="mt-1 block w-full" />
            ...
            <FormSection @submitted="store">
                ...
                <template #description>
                    This option determine how the api will handle the defined airports. In case of execlude, the API
                    will execlude the defined airports, wich will affect on schedule sync, and offer pricing.
                    Th case of include, the API will include the defined airports only, which cause the API schedule
                    fetching and pricing on the defined airports only.
                </template>

                <template #form>
                    <div class="col-span-6 sm:col-span-4">
                        <InputLabel for="airport_management_type" value="Airport management type" />
                        <select v-model="form.airport_management_type" class="mt-1 block w-3/4">
                            <option value="" disabled>Select Option</option>
            ...
            <FormSection @submitted="store" v-if="form.airport_management_type == 'execulde'">
                ...
                <template #form>
                    <div class="col-span-6 sm:col-span-4"
                        v-for="(execluded_airport, index) in form.execluded_airports">
                        <InputLabel for="name" value="Name" />
                        <TextInput id="name" ref="name" :value="execluded_airport"
                            v-model="form.execluded_airports[index]" type="text" class="mt-1 block w-full" />
            ...
            <FormSection @submitted="store" v-if="form.airport_management_type == 'include'">
                ...
                <template #form>
                    <div class="col-span-6 sm:col-span-4" v-for="(included_airport, index) in form.included_airports">
                        <InputLabel for="name" value="Name" />
                        <TextInput id="name" ref="name" :value="included_airport"
                            v-model="form.included_airports[index]" type="text" class="mt-1 block w-full" />
            ...
            <FormSection @submitted="store">
                ...
                <template #form>
                    ...
                    <div class="col-span-12 sm:col-span-4" v-for="(cabin_class, index) in form.cabins.economy">
                        <InputLabel for="name" value="Class" />
                        <TextInput id="name" ref="name" :value="cabin_class.class_code"
                            v-model="form.cabins.economy[index].class_code" type="text" class="mt-1 block w-full" />
                        <label class="inline-flex items-center mt-3">
                            <input type="checkbox" class="form-checkbox" v-model="form.cabins.economy[index].allow_open_booking">
                            <span class="ms-2">Allow Open Booking</span>
                        </label>
                    </div>

                        <div class="col-span-12 sm:col-span-4">
                        <button type="button" @click=" form.cabins.economy.push({ allow_open_booking: false , class_code: ''})">+</button>
                    </div>
                    ...
                    <div class="col-span-12 sm:col-span-4" v-for="(cabin_class, index) in form.cabins.business">
                        <InputLabel for="name" value="Class" />
                        <TextInput id="name" ref="name" :value="cabin_class.class_code"
                            v-model="form.cabins.business[index].class_code" type="text" class="mt-1 block w-full" />
                        <label class="inline-flex items-center mt-3">
                            <input type="checkbox" class="form-checkbox" v-model="form.cabins.business[index].allow_open_booking">
                            <span class="ms-2">Allow Open Booking</span>
                        </label>
                    </div>

                        <div class="col-span-12 sm:col-span-4">
                        <button type="button" @click=" form.cabins.business.push({ allow_open_booking: false , class_code: ''})">+</button>
                    </div>
