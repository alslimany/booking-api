...
class UpdatePriceTest extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:update-price-test';
    ...
    {
        $this->availability = \App\Models\FlightAvailablity::find($this->availability);
            ...
            if (!cache()->has($cache_key)) {
                ...
                if ($offers['status'] == "OK") {
                    ...
                    foreach ($offers['data'] as $offer) {
                        ...
                        // $this->info(print_r($offer));
                    }

                } else {
                    $this->info("status not ok");
                }
            }
        }
    }
